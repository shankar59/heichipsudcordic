...
set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports waveform_sel[0]]
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports waveform_sel[1]]
...
#set_property -dict { PACKAGE_PIN G3   IOSTANDARD LVCMOS33 } [get_ports pwm_data];#Sch name = JA10
...
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports pwm_data];#Sch name = JC10
